...
extern u16 windSpeed;//300001
extern u16 windDir;//300002
extern u16 OutdoorTemperature;//300003
extern u16 OutdoorHumidity;//300004 
...
extern u16 noise; //300009

extern u32 CoPpm;//3000010 - 300011
extern u32 No2Ppm;//300012 - 300013
extern u32 So2Ppm;//300014 - 300015
extern u32 O3Ppm;//300016 - 300017
extern u32 H2sPpm;//300018 - 300019
extern u32 TVOCPpm;//300020 - 300021

u16 inputRegFirst = 666;
u16 holdRegFirst = 888;
...
//        Modbus_OutputIO[1]=(vu32*)&PEout(5);//LED1
        ...
        //保持寄存器指针指向
				Modbus_HoldReg[0] = &holdRegFirst; 
	
        Modbus_HoldReg[1] = &windSpeedDirType; 
        Modbus_HoldReg[2] = &noiseType;  
				Modbus_HoldReg[3] = &laserType; 
			//输入寄存器指针指向
				Modbus_InputReg[0] = &inputRegFirst;
	
				Modbus_InputReg[1] = &windSpeed;
				Modbus_InputReg[2] = &windDir;
				Modbus_InputReg[3] = &OutdoorTemperature;
				Modbus_InputReg[4] = &OutdoorHumidity;
				Modbus_InputReg[5] = &pressure;
	
				Modbus_InputReg[6] = &LaserTsp;
				Modbus_InputReg[7] = &LaserPm10;
				Modbus_InputReg[8] = &LaserPm25;
				
				Modbus_InputReg[9] = &noise;
				
				Modbus_InputReg[10] = (u16*)&CoPpm;
				Modbus_InputReg[11] = ((u16*)&CoPpm) +1;
				
				Modbus_InputReg[12] = (u16*)&No2Ppm;
				Modbus_InputReg[13] = ((u16*)&No2Ppm) +1;
				
				Modbus_InputReg[14] = (u16*)&So2Ppm;
				Modbus_InputReg[15] = ((u16*)&So2Ppm) +1;
				
				Modbus_InputReg[16] = (u16*)&O3Ppm;
				Modbus_InputReg[17] = ((u16*)&O3Ppm)+1;
				
				Modbus_InputReg[18] = (u16*)&H2sPpm;
				Modbus_InputReg[19] = ((u16*)&H2sPpm)+1;
